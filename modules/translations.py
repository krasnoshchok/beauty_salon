...
translations = {
    'pl': {
        ...
        'Reviews': 'Opinie',
        'Google Reviews Coming Soon': 'Opinie Google już wkrótce',
        'We are getting our Google Reviews connected. Check back shortly to see what our clients are saying!': 'Trwamy przy podłączaniu opinii Google. Zajrzyj tu wkrótce, aby zobaczyć, co mówią nasi klienci!',
        'Call Now': 'Zadzwon',
    ...
    'en': {
        ...
        'Reviews': 'Reviews',
        'Google Reviews Coming Soon': 'Google Reviews Coming Soon',
        'We are getting our Google Reviews connected. Check back shortly to see what our clients are saying!': 'We are getting our Google Reviews connected. Check back shortly to see what our clients are saying!',
        'Call Now': 'Call Now',
    ...
    'uk': {
        ...
        'Reviews': 'Відгуки',
        'Google Reviews Coming Soon': 'Відгуки Google скоро з’являться',
        'We are getting our Google Reviews connected. Check back shortly to see what our clients are saying!': 'Ми підключаємо відгуки Google. Зазирніть трохи пізніше, щоб побачити, що кажуть наші клієнти!',
